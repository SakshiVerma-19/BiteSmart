...
def analyze():
    ...
    try:
        ...
        # Base64 encode the image as requested by user instructions
...
{{
  ...
  "warning": "main health warning for this person's goal, or empty string if none",
...
- stay_healthy: balanced scoring"""
        ...
        fallback = {
          ...
          "is_indian": False,
          "calories": 0, "protein_g": 0, "fat_g": 0, "sugar_g": 0,
          "health_score": 0,
          "score_reason": "Could not analyze the image.",
          "warning": "Please upload a clear food photo.",
          "context_note": "", "swap_dish": "", "swap_calories": 0,
          "swap_score": 0, "calorie_saving": 0
        }
